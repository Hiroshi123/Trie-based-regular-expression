...
/* package regpuchi-0.1.0.0 */
#define VERSION_regpuchi "0.1.0.0"
#define MIN_VERSION_regpuchi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "regpuchi-0.1.0.0-GMF9tt5GphaELrw8R3G8mc"

#define CURRENT_PACKAGE_KEY "regpuchi-0.1.0.0-GMF9tt5GphaELrw8R3G8mc"
